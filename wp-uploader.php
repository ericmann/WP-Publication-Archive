...
class wp_uploader {
  ...
  */    
  function wpup_print_doc($post){
    ...
    if( (class_exists("userGroups") && $userGroups->ugHasAccess($user_ID, $post->ID, $permission, $plugName)) || !(class_exists("userGroups"))){
      ...
      $data = explode("-", $doc->date);
      
      echo date("d F Y",mktime(0,0,0, $data[1], $data[2], $data[0]));
  ...
  */
  function wp_uploader_menu(){
    ...
    add_menu_page('Publications', 'Publications',1, "wp-publications-archive/upload.php");
   
    add_submenu_page('wp-publications-archive/upload.php', 'Upload',           'Upload'           ,1, "wp-publications-archive/upload.php", array("wp_uploader", "uploadPage") );
  
    add_submenu_page('wp-publications-archive/upload.php', 'Files',     'Files'     ,1, "wp-publications-archive/manageFiles.php");
  
    add_submenu_page('wp-publications-archive/upload.php', 'Categories','Categories',1, "wp-publications-archive/manageCategories.php");
  
    add_submenu_page('wp-publications-archive/upload.php', ' Extensions  ',           ' Extensions '           ,1, "wp-publications-archive/config.php");
  
    add_submenu_page('wp-publications-archive/upload.php', 'Settings',     'Settings'     ,1, "wp-publications-archive/frontOfficeConfig.php");
