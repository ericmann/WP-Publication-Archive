...
<div class="wrap">
  <h2>Upload</h2>
  <form id="uploadForm" enctype="multipart/form-data" method="post" action="?page=wp-publications-archive/upload.php&amp;mode=update" onsubmit="toggleButton(getElementById('bt_upload')); return true;">
    <table>
      <tr>
        ...
        <td>
          <input name="title" value="<? echo $title; ?>" id="title" type="text" maxlength="70" style="width: 470px"/>
          <br />
        </td>
      </tr>
      <tr>
        ...
        <td style="vertical-align:top">
          ...
          </select> <input name="day" value="<? echo $day; ?>" id="day" type="text" maxlength="2" style="width: 18px"/> <input name="year" value="<? echo $year; ?>" id="year" type="text" maxlength="4" style="width: 35px"/> 
        </td>        
      </tr>
      <tr>
        <td>
